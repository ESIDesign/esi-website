...
if($('body').hasClass('page-template-template-people')) {
	$(document).ready(function(){	
		Grid.init();
// 		Grid.addItems($('.og-grid2').children('li'));
