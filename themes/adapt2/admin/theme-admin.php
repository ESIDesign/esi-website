...
add_theme_page( __( 'Theme Settings', 'adapt' ), __( 'Theme Settings', 'adapt' ), 'manage_options', '-settings', 'adapt_theme_settings_page');
}
...
<div id="message" class="updated fade -message"><p><?php _e('Options Saved','adapt'); ?></p></div>
<?php } ?>

<div id="icon-options-general" class="icon32"></div>
<h2><?php _e( ' Theme Settings', 'adapt' ) ?></h2>
...
<td><p>The Theme was created by <a href="http://themeforest.net/user/WPExplorer?ref=wpexplorer"><strong>WPExplorer</strong></a></p>
</td>
</tr>
...
<input type="submit" class="button-primary" value="<?php _e( 'Save Options', 'adapt' ); ?>" />
</p>
</form>
</div><!-- END wrap -->
