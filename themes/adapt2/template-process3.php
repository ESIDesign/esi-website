	    ...
	    <?php if (get_field('principle1') != "") { 
			        ...
			        <?php			
						...
						if (get_field('module1') != "") { 
							echo '<article class="right"><p>Design Principle</p><h2>';
							echo get_field("module1_title");
							echo '</h2><h3>';
							echo strip_tags(substr(get_field("module1"), 0, 185));
							echo '</h3></article>';
					} ?>
	                </div>
			        ...
			        <?php
						if (get_field('module2') != "") { 
							echo '<article class="left"><p>Design Principle</p><h2>';
							echo get_field("module2_title");
							echo '</h2><h3>';
							echo strip_tags(substr(get_field("module2"), 0, 185));
							echo '</h3></article>';
						} 
			        ...
			        <?php
						...
						if (get_field('module3') != "") { 
							...
							echo '</h2><h3>';
							echo strip_tags(substr(get_field("module3"), 0, 185));
							echo '</h3></article>';
					} ?>
	                </div>
			        ...
			        <?php
						if (get_field('module4') != "") { 
							...
							echo '</h2><h3>';
							echo strip_tags(substr(get_field("module4"), 0, 185));
							echo '</h3></article>';
						}
	               ...
	               <div class="approach5">
			        <?php
						...
						if (get_field('module5') != "") { 
							...
							echo '</h2><h3>';
							echo strip_tags(substr(get_field("module5"), 0, 185));
							echo '</h3></article>';
					} ?>
	                </div>
